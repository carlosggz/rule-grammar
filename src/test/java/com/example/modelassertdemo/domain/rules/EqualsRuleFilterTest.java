...
class EqualsRuleFilterTest {
    private final EqualsRuleFilter filter = new EqualsRuleFilter();
    ...
    void happyPath() {
        //given
        var givenCriteria = new NumberCriteria("/intField", NumberMethod.EQUALS_TO, 12);
    ...
    void unhappyPath() {
        //given
        var givenCriteria = new NumberCriteria("/intField", NumberMethod.BETWEEN, 100);
